...
import TopicTable from "@/Pages/Topic/TopicTable.vue";
    ...
    <LayoutAuthenticated>
        <SectionMain>
            ...
            <div class="flex flex-wrap items-center justify-between mb-6 sm:flex-row flex-col">
                ...
                <BaseButton  color="info" label="Create a new Topic"
                            routeName="admin.topics.create"/>
            </div>
            <CardBox v-if="props.Topics?.data?.length > 0" class="mb-6" has-table>
                <TopicTable :Topics="props.Topics" :Role="props.Role" @sort="sort"
