...
<template>
    <div class="bg-white rounded-lg  p-5 md:p-20 mx-2">
        ...
        <div class="px-4 py-5 sm:px-6 ">
            <div class="flex max-w-auto justify-end">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">
                    ...
                    <span class="font-bold p-3 leading-loose bg-blue-500 text-white rounded-full">{{ step+1}}/{{ quiz.questions.length}}</span>
                </p>
            </div>
        </div>
