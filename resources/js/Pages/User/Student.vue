...
<template>
    ...
    <LayoutAuthenticated>
        <SectionMain>
            ...
            <trashed-message v-if="props.User.deleted_at" @restore="$emit('restore')" class="mb-6" :restore="`Are you sure you want to restore this ${props.Role}?`"> This {{ props.Role }} has been
                deleted.
            </trashed-message>
            <CardBox class=" overflow-hidden sm:rounded-lg mb-8">
                ...
                <div class="border-t border-gray-300">
                    <dl>
                        ...
                        <Overview class="border-t border-gray-300 mt-4" label="Total Answered Questions" :value="props.User.results_sum_total_questions"/>
                        <Overview  label="Correct Answered" :value="props.User.results_sum_correct_answered"/>
                        <Overview   label="Avg. Score" :value="score + '%'"/>
                    </dl>
                </div>
            </CardBox>
