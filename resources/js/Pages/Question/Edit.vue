...
const doDuplicateQuestion = ref(false);
const duplicateQuestion = () => {
  doDuplicateQuestion.value = true;
  updateQuestion();
}
const removeImage = () => {
  image.value = null;
...
const updateQuestion = () => {
   if (!doDuplicateQuestion.value && questions["_duplicate"]){
    delete questions["_duplicate"];
  }
  if (doDuplicateQuestion.value) {
    questions["_duplicate"] = true;
    doDuplicateQuestion.value = false;
  }
